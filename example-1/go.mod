module github.com/roderm/graphql-gateway-examples/example-1
...
require (
	...
	github.com/wundergraph/graphql-go-tools/examples/federation v0.0.0-20230120175735-a67b500e8d0c
