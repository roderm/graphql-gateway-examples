...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "AWSUser":
			resolverName, err := entityResolverNameForAWSUser(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "AWSUser": %w`, err)
			}
			switch resolverName {
			...
			case "findAWSUserByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findAWSUserByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindAWSUserByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "AWSUser": %w`, err)
				}
		...
		case "GitHubUser":
			resolverName, err := entityResolverNameForGitHubUser(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "GitHubUser": %w`, err)
			}
			switch resolverName {
			...
			case "findGitHubUserByID":
				id0, err := ec.unmarshalNID2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findGitHubUserByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindGitHubUserByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "GitHubUser": %w`, err)
				}
...
func entityResolverNameForAWSUser(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findAWSUserByID", nil
	}
	return "", fmt.Errorf("%w for AWSUser", ErrTypeNotFound)
}

func entityResolverNameForGitHubUser(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findGitHubUserByID", nil
	}
	return "", fmt.Errorf("%w for GitHubUser", ErrTypeNotFound)
}
